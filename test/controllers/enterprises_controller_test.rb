...
class EnterprisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enterprise" do
    assert_difference('Enterprise.count') do
      post enterprises_url, params: { enterprise: { name: @enterprise.name, slack_channel: @enterprise.slack_channel, slack_username: @enterprise.slack_username, slack_webhook: @enterprise.slack_webhook } }
    end
  ...
  test "should update enterprise" do
    patch enterprise_url(@enterprise), params: { enterprise: { name: @enterprise.name, slack_channel: @enterprise.slack_channel, slack_username: @enterprise.slack_username, slack_webhook: @enterprise.slack_webhook } }
